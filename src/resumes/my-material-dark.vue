  ...
  <div class="rightCol">
    ...
    <div class="block" v-for="experience in person.experience" :key="experience.company">
      ...
      <h3 class="headline">{{experience.position}} - {{experience.company}}</h3>
        ...
        <div class="subinfo" v-for="desc in experience.subdesc" :key="experience.subdesc">
           {{desc}}
        </div>
    </div>
...
.rightCol {
  ...
  .block {
    ...
    .headline {
      ...
      display:block;
      font-size:14px;
      color: rgba(0, 56, 143, 0.87);
    }
    .subheadline {
      color: rgba(0, 56, 143, 0.54);
      display:block;
      font-size:13px;
      font-weight:300;
    }
...
#myselfpic {
  background-image:url('../../resume/myid.jpg');
  color:black;
}
</style>
